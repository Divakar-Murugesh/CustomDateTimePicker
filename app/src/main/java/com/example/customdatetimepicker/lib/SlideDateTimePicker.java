...
public class SlideDateTimePicker {
    ...
    public static boolean TIME_PICKER_ONLY = false;
    public static boolean DATE_PICKER_OMLY = false;
    ...
    public static class Builder {
        ...
        public Builder setDatePickerOnly() {
            SlideDateTimePicker.DATE_PICKER_OMLY = true;
            SlideDateTimePicker.TIME_PICKER_ONLY = false;
            return this;
        }
